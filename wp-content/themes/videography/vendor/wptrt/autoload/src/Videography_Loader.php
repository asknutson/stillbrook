...
class Videography_Loader {
	 ...
	 * @return void
	 */
	public function videography_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function videography_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function videography_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function videography_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->videography_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function videography_load( $class ) {
